...
- [Arena: HarnessTax](https://arena.ai/blog/coding-agents-harness-tax) - Twenty-one model and harness pairs across Claude Code, Codex CLI, and Pi on SWE-bench Lite and Terminal-Bench 2.0: harness choice moves success by a few points but cost by up to 5x.
