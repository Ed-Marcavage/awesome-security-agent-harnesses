...
- [sofagent](https://github.com/KongFangXun/sofagent) - Commit-time audit harness that blocks credential leaks and out-of-scope edits before a commit lands, enforcing codified git-diff rules with an HMAC-chained audit trail and snapshot rollback. `SKILL.md`.
